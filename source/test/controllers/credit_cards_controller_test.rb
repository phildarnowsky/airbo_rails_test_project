...
class CreditCardsControllerTest < ActionController::TestCase
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post :create, credit_card: { amount: @credit_card.amount, currency: @credit_card.currency, customer_id: @credit_card.customer_id, paid: @credit_card.paid, refunded: @credit_card.refunded }
    end
  ...
  test "should update credit_card" do
    patch :update, id: @credit_card, credit_card: { amount: @credit_card.amount, currency: @credit_card.currency, customer_id: @credit_card.customer_id, paid: @credit_card.paid, refunded: @credit_card.refunded }
    assert_redirected_to credit_card_path(assigns(:credit_card))
  end
